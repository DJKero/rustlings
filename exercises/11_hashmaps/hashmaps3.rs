...
fn build_scores_table(results: String) -> HashMap<String, Team> {
    ...
    for r in results.lines() {
        ...
        if let Some(team_1) = scores.get_mut(&team_1_name) {
            team_1.goals_scored += team_1_score as u8;
            team_1.goals_conceded += team_2_score as u8;
        }
        else {
        ...
        if let Some(team_2) = scores.get_mut(&team_2_name) {
            team_2.goals_scored += team_2_score as u8;
            team_2.goals_conceded += team_1_score as u8;
        }
        else {
